...
@Component({
  selector: 'app-eliminar-usuario-sp-ad',
  templateUrl: './eliminar-usuario-sp-ad.component.html',
  styleUrls: ['./eliminar-usuario-sp-ad.component.css']
})
export class EliminarUsuarioSpAdComponent {
  ...
  cargarUsuariosAdmin(): void {
    this.backendService.mostrarUsuarios().subscribe(
      (response) => {
  ...
  buscarUsuarioCompleto(): void {
    ...
    this.backendService.buscarUsuariosPorNombre(nombreCompleto).subscribe(
      (response) => {
